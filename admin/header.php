            ...
            <div class="navbar-custom">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user mr-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img style="width: 32px" src="https://www.clipartkey.com/mpngs/m/276-2764901_www-agisac-gov-in-admin-png.png" alt="user-image" class="rounded-circle">
                            <span class="pro-user-name ml-1">
                                    Xin chào Admin!  <i class="mdi mdi-chevron-down"></i> 
                            </span>
                        </a>
                ...
                <div class="logo-box">
                    <a href="index.html" class="logo text-center logo-dark">
                        <span class="logo-lg">
                            <img style="width: 106px" src="https://www.hathanhauto.com/uploads/images/logo%20truoc%20xe%20Chrysler(1).jpg" alt="" height="56">
